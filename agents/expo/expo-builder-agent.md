...
description: >
  Expo/React Native implementation specialist for OS 6.0. Implements mobile
...
5. **Summarize changes**
   ...
   - **RA tag summary: `ra_tags_added: N, critical_assumptions: [list]`** (OS 6.0)
...
---
## 4.6 Response Awareness Tagging (OS 6.0)
