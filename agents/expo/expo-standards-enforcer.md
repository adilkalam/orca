...
- **relatedStandards from ContextBundle** - treat as enforceable rules, not suggestions (OS 6.0).
...
- **Reflexion** - verbal reflection on failure causes (OS 6.0, only if CAUTION/FAIL).
