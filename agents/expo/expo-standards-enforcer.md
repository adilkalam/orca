...
- **relatedStandards from ContextBundle** - treat as enforceable rules, not suggestions (OS 5.2).
...
- **Reflexion** - verbal reflection on failure causes (OS 5.2, only if CAUTION/FAIL).
