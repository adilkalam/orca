...
description: >
  Expo/React Native verification agent for OS 4.0. Runs build/tests and
...
# Expo Verification – OS 4.0 Verification Agent
...
You are the **Expo Verification Agent** for the OS 4.0 Expo lane.
...
---
## 5.5 Reflexion on Failure (OS 4.0)
...
## 7. Chain of Verification Protocol (OS 4.0)
