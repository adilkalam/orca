...
description: >
  Expo/React Native verification agent for OS 5.2. Runs build/tests and
...
# Expo Verification – OS 5.2 Verification Agent
...
You are the **Expo Verification Agent** for the OS 5.2 Expo lane.
...
---
## 5.5 Reflexion on Failure (OS 5.2)
...
## 7. Chain of Verification Protocol (OS 5.2)
