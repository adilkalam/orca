...
- For SwiftUI: Verify frame modifiers provide space to align within
- Before claiming alignment is complete, document what was intended
- If you have simulator access via XcodeBuildMCP, output an ALIGNMENT_CHECK block
- If not, document alignment intent for ios-verification to verify visually
...
---
## Response Awareness Tagging (OS 5.2)
