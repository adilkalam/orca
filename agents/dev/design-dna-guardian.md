...
description: >
  Cross-domain design DNA/token enforcement. Blocks ad-hoc styling and ensures
  token-only colors/typography/spacing. Used by iOS, Expo, and Django-React lanes.
