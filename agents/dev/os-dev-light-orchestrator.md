...
description: >
  Light orchestrator for OS development tasks (default path). Handles both default mode
...
# OS-Dev Light Orchestrator – OS 4.1 Three-Tier Routing
...
**You handle modes 1 and 2.** Mode 3 goes to `os-dev-grand-architect`.
...
- Version references consistent (OS 4.1)
