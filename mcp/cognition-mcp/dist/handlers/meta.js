...
export async function handleMeta(args, session) {
    ...
    const metaContent = validation.data;
    ...
    return buildResponse(metaContent, args, session, 'meta', shouldComplete ? 'exported' : 'stored', exportPath);
}
