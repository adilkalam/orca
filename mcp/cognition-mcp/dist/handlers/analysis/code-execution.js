...
export async function handleCodeExecution(args, session) {
    ...
    const codeContent = validation.data;
    ...
    return buildResponse(codeContent, args, session, 'codeExecution', shouldComplete ? 'exported' : 'stored', exportPath);
}
