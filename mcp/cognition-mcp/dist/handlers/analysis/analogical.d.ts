...
export declare function handleAnalogicalReasoning(args: CognitionRequest, session: SessionState): Promise<HandlerResult>;
//# sourceMappingURL=analogical.d.ts.map