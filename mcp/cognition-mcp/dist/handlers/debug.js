...
export async function handleDebug(args, session) {
    ...
    const debugContent = validation.data;
    ...
    return buildResponse(debugContent, args, session, 'debugging', shouldComplete ? 'exported' : 'stored', exportPath);
}
