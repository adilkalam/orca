...
export async function handleCreativeThinking(args, session) {
    ...
    const creativeContent = validation.data;
    ...
    return buildResponse(creativeContent, args, session, 'creative', shouldComplete ? 'exported' : 'stored', exportPath);
}
