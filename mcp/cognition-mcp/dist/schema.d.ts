...
export declare const ThoughtContentSchema: z.ZodObject<{
    ...
    thought: z.ZodString;
    thoughtNumber: z.ZodDefault<z.ZodNumber>;
    totalThoughts: z.ZodDefault<z.ZodNumber>;
...
export declare const DebugContentSchema: z.ZodObject<{
    ...
    nextThoughtNeeded: z.ZodOptional<z.ZodBoolean>;
    inferenceType: z.ZodOptional<z.ZodEnum<["abductive", "deductive", "inductive", "mixed"]>>;
    divergencePoints: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    rootCauseChain: z.ZodOptional<z.ZodObject<{
        symptom: z.ZodString;
        proximateCause: z.ZodString;
        intermediateCauses: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
        rootCause: z.ZodString;
        fiveWhysDepth: z.ZodOptional<z.ZodNumber>;
    }, "strip", z.ZodTypeAny, {
        symptom: string;
        proximateCause: string;
        rootCause: string;
        intermediateCauses?: string[] | undefined;
        fiveWhysDepth?: number | undefined;
    }, {
        symptom: string;
        proximateCause: string;
        rootCause: string;
    ...
    resolutionTargets: z.ZodOptional<z.ZodEnum<["symptom", "proximate", "intermediate", "root"]>>;
}, "strip", z.ZodTypeAny, {
    text?: string | undefined;
    steps?: string[] | undefined;
    nextThoughtNeeded?: boolean | undefined;
    ...
    inferenceType?: "abductive" | "deductive" | "inductive" | "mixed" | undefined;
    divergencePoints?: string[] | undefined;
    rootCauseChain?: {
        symptom: string;
        proximateCause: string;
        rootCause: string;
    ...
    resolutionTargets?: "symptom" | "proximate" | "intermediate" | "root" | undefined;
}, {
    text?: string | undefined;
    steps?: string[] | undefined;
    nextThoughtNeeded?: boolean | undefined;
...
export declare const MetaContentSchema: z.ZodObject<{
    ...
    insights: z.ZodEffects<z.ZodOptional<z.ZodString>, string | undefined, unknown>;
    nextThoughtNeeded: z.ZodOptional<z.ZodBoolean>;
...
export declare const SystemsContentSchema: z.ZodObject<{
    ...
    feedbackLoops: z.ZodEffects<z.ZodOptional<z.ZodArray<z.ZodString, "many">>, string[] | undefined, unknown>;
    nextThoughtNeeded: z.ZodOptional<z.ZodBoolean>;
}, "strip", z.ZodTypeAny, {
    text?: string | undefined;
    nextThoughtNeeded?: boolean | undefined;
...
export declare const CreativeIdeaSchema: z.ZodObject<{
    ...
    challenges: z.ZodEffects<z.ZodArray<z.ZodString, "many">, string[], unknown>;
}, "strip", z.ZodTypeAny, {
    idea: string;
    potential: string;
    challenges: string[];
...
export declare const CollaborativeReasoningContentSchema: z.ZodObject<{
    ...
    tensions: z.ZodEffects<z.ZodOptional<z.ZodArray<z.ZodString, "many">>, string[] | undefined, unknown>;
    synthesis: z.ZodOptional<z.ZodString>;
    nextThoughtNeeded: z.ZodOptional<z.ZodBoolean>;
}, "strip", z.ZodTypeAny, {
    text?: string | undefined;
...
export declare const AnalogSchema: z.ZodObject<{
    domain: z.ZodString;
    description: z.ZodString;
    similarity: z.ZodEffects<z.ZodNumber, number, unknown>;
}, "strip", z.ZodTypeAny, {
    description: string;
    domain: string;
    similarity: number;
...
export declare const CausalChainSchema: z.ZodEffects<z.ZodObject<{
...
export declare const CausalAnalysisContentSchema: z.ZodObject<{
    ...
    chains: z.ZodArray<z.ZodEffects<z.ZodObject<{
        sequence: z.ZodArray<z.ZodString, "many">;
        probability: z.ZodNumber;
    }, "strip", z.ZodTypeAny, {
        sequence: string[];
