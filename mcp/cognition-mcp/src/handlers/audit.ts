...
import type { CognitionRequest, HandlerResult, AuditContent } from '../types.js';
...
export async function handleAudit(
  ...
  const auditContent = validation.data as AuditContent;
  ...
  return buildResponse(
    auditContent as unknown as Record<string, unknown>,
    args,
    session,
    'audit',
