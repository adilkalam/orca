...
import type { CognitionRequest, HandlerResult, ScientificMethodContent } from '../../types.js';
...
export async function handleScientificMethod(
  ...
  const scientificContent = validation.data as ScientificMethodContent;
  ...
  return buildResponse(
    scientificContent as unknown as Record<string, unknown>,
    args,
    session,
    'scientific',
