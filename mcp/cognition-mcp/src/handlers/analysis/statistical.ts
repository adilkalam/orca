...
import type { CognitionRequest, HandlerResult, StatisticalReasoningContent } from '../../types.js';
import { validateOperationContent } from '../../schema.js';
import { SessionState } from '../../session/state.js';
import { getSessionManager } from '../../session/manager.js';
import { buildResponse } from '../shared.js';

export async function handleStatisticalReasoning(
  ...
  const statisticalContent = validation.data as StatisticalReasoningContent;
  ...
  return buildResponse(
    statisticalContent as unknown as Record<string, unknown>,
    args,
    session,
    'statistical',
