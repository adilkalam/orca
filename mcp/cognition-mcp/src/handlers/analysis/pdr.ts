...
import type { CognitionRequest, HandlerResult, PDRReasoningContent } from '../../types.js';
import { validateOperationContent } from '../../schema.js';
import { SessionState } from '../../session/state.js';
import { getSessionManager } from '../../session/manager.js';
import { buildResponse } from '../shared.js';

export async function handlePDRReasoning(
  ...
  const pdrContent = validation.data as PDRReasoningContent;
  ...
  return buildResponse(
    pdrContent as unknown as Record<string, unknown>,
    args,
    session,
    'pdr',
