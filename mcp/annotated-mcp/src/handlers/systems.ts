...
import type { CognitionRequest, HandlerResult, SystemsContent } from '../types.js';
...
export async function handleSystems(
  ...
  const systemsContent = validation.data as SystemsContent;
  ...
  return buildResponse(
    systemsContent as unknown as Record<string, unknown>,
    args,
    session,
    'systems',
