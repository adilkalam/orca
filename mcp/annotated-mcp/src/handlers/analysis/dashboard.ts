...
import type { CognitionRequest, HandlerResult, VisualDashboardContent } from '../../types.js';
import { validateOperationContent } from '../../schema.js';
import { SessionState } from '../../session/state.js';
import { getSessionManager } from '../../session/manager.js';
import { buildResponse, buildErrorResponse } from '../shared.js';

export async function handleVisualDashboard(
  ...
  const dashboardContent = validation.data as VisualDashboardContent;
  ...
  return buildResponse(
    dashboardContent as unknown as Record<string, unknown>,
    args,
    session,
    'dashboard',
