...
import type { CognitionRequest, HandlerResult, AnalogicalReasoningContent } from '../../types.js';
import { validateOperationContent } from '../../schema.js';
import { SessionState } from '../../session/state.js';
import { getSessionManager } from '../../session/manager.js';
import { buildResponse, buildErrorResponse } from '../shared.js';

export async function handleAnalogicalReasoning(
  ...
  const analogicalContent = validation.data as AnalogicalReasoningContent;
  ...
  return buildResponse(
    analogicalContent as unknown as Record<string, unknown>,
    args,
    session,
    'analogical',
