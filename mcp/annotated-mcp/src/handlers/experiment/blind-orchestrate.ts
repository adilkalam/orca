...
interface BlindOrchestrateContent {
  problem: string;
  reasoning?: string;
  step: number;
}
...
export async function handleBlindOrchestrate(
  args: CognitionRequest,
  session: SessionState
): Promise<HandlerResult> {
  const content = args.content as unknown as BlindOrchestrateContent | undefined;
