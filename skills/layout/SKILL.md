...
## Alignment precision (NEW — runs throughout)

Apply the 7 optical alignment rules + base grid system + pixel-perfect audit. See `~/.claude/docs/concepts/design-contract/preferences/alignment-precision.md`.
