...
description: >
  Skill providing structured knowledge about OS 5.1 / Claude Code configuration
...
# OS-Dev Knowledge Skill – OS 5.1 Configuration & Safety

**NOTE: This skill is LOCAL to claude-vibe-config repo only.**

This skill captures key knowledge for working on OS 5.1 / Claude Code config:
lanes, commands, agents, skills, MCPs, hooks, and memory integration.

Use this skill when:

- Planning changes to orchestration lanes or phase configs.
- Adding or modifying commands/agents/skills for OS 5.1.
...
changes to stay aligned with the overall OS 5.1 design philosophy.
