...
description: >
  Skill providing structured knowledge about OS 7.0 / Claude Code configuration
...
This skill captures key knowledge for working on OS 7.0 / Claude Code config:
...
changes to stay aligned with the overall OS 7.0 design philosophy.
