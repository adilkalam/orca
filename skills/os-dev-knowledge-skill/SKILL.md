...
description: >
  Skill providing structured knowledge about OS 4.2 / Claude Code configuration
...
# OS-Dev Knowledge Skill – OS 4.2 Configuration & Safety

**NOTE: This skill is LOCAL to claude-vibe-config repo only.**

This skill captures key knowledge for working on OS 4.2 / Claude Code config:
...
changes to stay aligned with the overall OS 4.2 design philosophy.
