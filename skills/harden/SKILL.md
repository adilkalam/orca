...
## Felt-state framing for edge states (NEW)

Empty states, error states, loading states designed for a user having a bad day, not for the happy-path ideal user. See `skills/interfaces-that-feel/SKILL.md` — "heartbreak as design brief" section. Otherwise defer to Bakaus + Emil for component-level hardening.
