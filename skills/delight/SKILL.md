...
## Earned-emotion proportionality (NEW — runs FIRST)

Every emotional moment must match what the user did. Consult `skills/interfaces-that-feel/SKILL.md` earned-emotion table:
