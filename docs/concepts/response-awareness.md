...
Response Awareness is OS 6.0's system for **making assumptions and decisions explicit** during agent work. RA is **instrumentation**, not a primary scoring mechanism: tags surface where the model is guessing, following bad framing, or making architectural choices so that gates, audits, and humans can react.
