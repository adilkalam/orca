...
OS 4.0 uses multiple memory systems to maintain context across sessions and provide relevant information to agents.
...
OS 4.0 checks fast, local memory before expensive queries:
