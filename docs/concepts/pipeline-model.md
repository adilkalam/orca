...
OS 4.0 uses a **multi-lane pipeline architecture** to handle different types of development work. Each "lane" is a domain-specific pipeline with its own agents, phases, and gates.
...
OS 4.0 enforces strict role separation:
