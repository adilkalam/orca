...
OS 4.1 introduces an agent self-improvement loop that enables agents to learn from execution history and improve their prompts over time.

---

## System Overview

OS 4.1 provides learning at three levels:
...
# Reflexion-Enhanced Gates (OS 4.1)

OS 4.1 introduces Reflexion-enhanced gates based on research by Shinn et al. (NeurIPS 2023). Gates now learn from failures through verbal reinforcement stored in episodic memory (Reflexion-style episodic memory).
...
# Chain of Verification (OS 4.1)

OS 4.1 introduces Chain of Verification (CoVe) based on Meta AI research (Dhuliawala et al., 2023). Verification agents now use structured verification questions to catch errors before reporting (CoVe-style question-then-verify loop).
