# Rant: Fonts (iOS/SwiftUI) — use the bundled brand face; don't collapse the display floor

> **Provenance.** Cross-platform spirit (the web `design-contract/rants/fonts.md` refuses the
