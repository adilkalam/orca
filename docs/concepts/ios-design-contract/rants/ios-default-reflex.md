# Rant: The iOS-default reflex — shipping the template instead of the brand

> **Provenance.** iOS-authored, owner-instructed. The SwiftUI sibling of the web
> `design-contract/rants/generic-ui-defaults.md` (iOS-as-default / pretend-variation), re-expressed
