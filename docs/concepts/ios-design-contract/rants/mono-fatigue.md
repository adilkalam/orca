# Rant: Monospace fatigue (iOS/SwiftUI) — mono is a micro-label whitelist, not a "technical" wash

> **Provenance.** Cross-platform refusal. Same enemy as the web
> `design-contract/rants/typography-mono.md` (monospace-as-"technical"-shorthand), authored here
...
> right move for figures and is distinct from setting type in the mono *family*. The rant
