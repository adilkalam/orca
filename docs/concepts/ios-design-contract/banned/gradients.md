# Banned: Gradients (iOS/SwiftUI) — the decorative AI tell, ported to SwiftUI

> **Provenance.** Cross-platform refusal. Same enemy as the web
> `design-contract/banned/gradients.md` (AI-purple/magenta/pink gradients, `background-clip:text`
...
full-bleed hero, where it reads as light falloff, not as decoration) is not what this ban
