# Banned: Spring overshoot (iOS/SwiftUI) — real objects decelerate; they don't bounce

> **Provenance.** Cross-platform refusal. Same enemy as the web
> `design-contract/banned/motion-suddenness.md` (the bounce/elastic easing tell), authored here
