# Banned: Shadow / material / glassmorphism reflex (iOS/SwiftUI) — restraint over faux-depth

> **Provenance.** Cross-platform spirit (the web `design-contract/banned/skeuomorphism.md` +
