# Banned: Magic-number spacing (iOS/SwiftUI) — route rhythm through the scale

> **Provenance.** iOS-authored, in the spirit of the web alignment/spacing discipline
> (`design-contract/banned/alignment-spacing.md` + `preferences/typography-spacing.md`). The web
