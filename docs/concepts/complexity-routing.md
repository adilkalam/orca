# Complexity Routing – OS 4.0 Three-Tier Structure

OS 4.0 uses **three-tier routing** to optimize for speed while maintaining quality gates.
...
**Key Inversion (v4.0):** Default now runs gates. Previous versions skipped them.
