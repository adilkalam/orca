# Complexity Routing – OS 3.0 Three-Tier Structure

OS 3.0 uses **three-tier routing** to optimize for speed while maintaining quality gates.
...
**Key Inversion (v3.0):** Default now runs gates. Previous versions skipped them.
