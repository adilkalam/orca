# Banned: Colors — the Tailwind palette as the enemy
...
The source critique names "clinical" as the enemy word. Clinical = sterile, flat, information-palette, Bootstrap-era, "this is a bug-tracker" feel. Detection is heuristic (no pure regex) but these are the tells:
...
## Named substitutes (voice-anchored: these came directly from the owner's critique)
