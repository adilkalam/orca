# Banned: Typography — Mono Overuse
...
Any of these patterns appearing in new work is an automatic-fail under this ban.
...
- Adjacent fonts ban (general typography monoculture): `~/.claude/docs/concepts/design-contract/banned/fonts.md`
