...
The Claude Code compaction system was leaving 135k tokens after compaction, giving only ~20k tokens of working space. This was untenable for OS 3.0 orchestration.
