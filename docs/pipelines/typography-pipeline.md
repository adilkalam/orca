...
**Status:** OS 7.0 Pipeline (Typography)
...
It combines:
- OS 7.0 primitives (phase_state.json, Workshop memory)
...
- Web typography CSS (use nextjs pipeline)
...
```bash
# After every task
workshop decision "Typography: {operation} on {font}" -r "auto-recorded"
