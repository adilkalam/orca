...
- OS 5.2 primitives (ProjectContextServer, phase_state.json, code-index.db, Workshop, constraint framework)
...
### CSS Architecture Refactor Mode (OS 5.2)
...
## Standards Inputs (OS 5.2 Learning Loop)
...
verification_required:
  ...
  - standards_audit: "Via nextjs-standards-enforcer"
  - design_qa: "Via nextjs-design-reviewer"
...
- Tailwind (tailwind.config.* or @import 'tailwindcss') → `tailwind-specialist`
- shadcn/ui (components.json or components/ui/) → `shadcn-specialist`
