...
**Status:** OS 3.0 Adjacent Pipeline (SEOOptimizerPipeline)  
...
It combines:
- OS 3.0 primitives (ProjectContextServer, `phase_state.json`, Workshop/vibe.db).
...
- All phases should respect:
  ...
  - OS 3.0 agent role boundaries (orchestrators coordinate, specialists implement).
