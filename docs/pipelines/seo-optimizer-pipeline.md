...
**Status:** OS 6.0 Adjacent Pipeline (SEOOptimizerPipeline)  
...
It combines:
- OS 6.0 primitives (ProjectContextServer, `phase_state.json`, Workshop/code-index.db).
...
- All phases should respect:
  ...
  - OS 6.0 agent role boundaries (orchestrators coordinate, specialists implement).
