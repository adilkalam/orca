...
**Status:** OS 5.2 Adjacent Pipeline (SEOOptimizerPipeline)  
...
It combines:
- OS 5.2 primitives (ProjectContextServer, `phase_state.json`, Workshop/code-index.db).
...
- All phases should respect:
  ...
  - OS 5.2 agent role boundaries (orchestrators coordinate, specialists implement).
