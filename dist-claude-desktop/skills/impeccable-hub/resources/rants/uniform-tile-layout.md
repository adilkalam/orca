# Rant: Uniform-tile dashboard layout
...
- `~/.claude/docs/concepts/design-contract/rants/generic-ui-defaults.md` — adjacent failure (defaulting to platform-stock UI register)
- `~/.claude/docs/concepts/design-contract/rants/alignment-spacing.md` — adjacent failure (spacing-without-thought, floating elements)
