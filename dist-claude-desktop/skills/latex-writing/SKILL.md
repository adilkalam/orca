...
name: latex-writing
description: >
  Writes syntactically correct LaTeX source for a new .tex document (sections, math, tables,
  figures) that compiles cleanly with pdflatex. Use when the user asks for a LaTeX document,
  a paper/report in LaTeX, or to typeset content as LaTeX.
---
