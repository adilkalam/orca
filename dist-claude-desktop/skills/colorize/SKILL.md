...
Read the `impeccable-hub` skill first if available this conversation. Additionally gather: existing brand colors.

---

## Tailwind palette refused

Utility classes like `bg-blue-500` and direct hex matches on Tailwind 500-shade values read as generic/AI-default. Reach for material-derived substitutes instead:
- Instead of tech-orange → brass / gold (OKLCH ~L 0.75 C 0.12 H 80)
- Instead of tech-blue → confirm the exact hue with the user rather than defaulting
