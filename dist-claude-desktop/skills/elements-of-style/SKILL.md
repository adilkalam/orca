...
description: >
  Applies high-impact writing rules from Strunk's Elements of Style (1918, public domain) —
  active voice, positive form, concrete language, omitting needless words, and varied sentence
  structure. Use when editing or drafting prose for clarity and force, or when the user asks to
  tighten, strengthen, or clean up writing.
---
