# Quick Reference: /requirements Command (OS 7.0)

The `/requirements` command creates blueprint-quality requirements specs before implementation.
...
/requirements --visual Redesign checkout flow
