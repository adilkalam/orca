# Visual Design Spec — Quick Reference (OS 4.0)

**Version:** OS 4.0
**Last Updated:** 2025-12-05

Use this template to define clear, testable acceptance criteria for visual work. In OS 4.0, design QA is **automated** within pipelines via design-reviewer agents.
