# Visual Design Spec — Quick Reference (OS 7.0)

**Version:** OS 7.0
**Last Updated:** 2026-02-07

Use this template to define clear, testable acceptance criteria for visual work. In OS 7.0, design QA is **automated** within pipelines via design-reviewer agents.
...
- `/requirements "feature"` → Include visual acceptance criteria in blueprint
- `/{domain} "implement"` → Design QA runs automatically
...
Design QA is handled automatically by domain pipelines (e.g., `/nextjs`, `/ios`). Use `/design-review` for standalone visual review.
