# Visual Design Spec — Quick Reference (OS 5.2)

**Version:** OS 5.2
**Last Updated:** 2026-02-07

Use this template to define clear, testable acceptance criteria for visual work. In OS 5.2, design QA is **automated** within pipelines via design-reviewer agents.
