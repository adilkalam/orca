...
Without constraints:
         ...
         |  o o o * * * * * * * o o o o o o   |  <-- Lands in dense center
         | o o o o * * * * * * o o o o o o o  |      (median quality)
         |  o o o o o o o o o o o o o o o o   |
         |                                    |
         | X                              X   |  <-- Quality lives at edges
         +------------------------------------+
...
~90 agents across core domains:

| Domain | Agents | Entry Point |
|--------|--------|-------------|
| iOS | 19 | `/ios` |
| Next.js | 17 | `/nextjs` |
| Django-React | 13 | `/django-react` |
| Expo | 11 | `/expo` |
| Research | 7 | `/research` |
| SEO | 4 | `/seo` |
...
**Domain Pipelines:**
- `/ios`, `/nextjs`, `/django-react`, `/expo`, `/research`, `/seo`
