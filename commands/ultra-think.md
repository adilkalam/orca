...
- Use `#GOSSAMER_KNOWLEDGE:` for weakly-held information
- Use `#POOR_OUTPUT_INTUITION:` when sensing analysis gaps

These meta-cognitive tags help surface uncertainties during deep analysis, which can then be verified systematically.
