---
description: "OS 4.1 Expo/React Native Orchestrator – coordinates the Expo lane pipeline, never writes code"
...
# /expo - Expo Lane Orchestrator (OS 4.1)
...
## 5. Standards Inputs (OS 4.1 Learning Loop)
