...
1. Create `{$PWD}/.orca/cognition/YYYYMMDD-CHALLENGE-<slug>/` directory (slug from the proposal summary, first 30 chars, kebab-cased). IMPORTANT: This is the PROJECT's `.claude/`, NOT `~/.claude/`. Use the absolute project root path.
...
1. Create a cognition session and register the command:
...
mcp__cognition-mcp__cognition
  ...
  content: {
    ...
    assumptions: [
      { assumption: "[assumption 1]", confidence: "high|medium|low", ifWrong: "[what breaks]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" },
      { assumption: "[assumption 2]", confidence: "high|medium|low", ifWrong: "[what breaks]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" },
      { assumption: "[assumption 3]", confidence: "high|medium|low", ifWrong: "[what breaks]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" }
    ],
    edgeCases: [
...
mcp__cognition-mcp__cognition
  ...
  content: {
    ...
    assumptions: [
      // For each assumption, also identify whether a specific cognitive bias is likely operating on it. `none` is a valid value; do not manufacture biases.
      { assumption: "[assumption 1]", confidence: "high|medium|low", ifWrong: "[impact]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" },
      { assumption: "[assumption 2]", confidence: "high|medium|low", ifWrong: "[impact]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" },
      { assumption: "[assumption 3]", confidence: "high|medium|low", ifWrong: "[impact]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" },
      { assumption: "[assumption 4]", confidence: "high|medium|low", ifWrong: "[impact]", bias: "anchoring|framing|authority|sunk_cost|availability|confirmation|none", biasEvidence: "[how bias may be operating, or none]" }
    ],
    edgeCases: [
      "[edge case 1]",
      "[edge case 2]",
...
mcp__cognition-mcp__cognition
  ...
  content: {
    phase: "harvest",
    sessionFolder: "<absolute path to {$PWD}/.orca/cognition/YYYYMMDD-CHALLENGE-slug/ -- project-local, NOT ~/.claude/>",
...
workshop --workspace .claude/memory note \
  "/challenge-local: [Proposal] - [Verdict]. Session: <sessionId>. File: .orca/cognition/<folder-name>/99-harvest.md" \
...
---
Analysis persisted:
  Folder: .orca/cognition/YYYYMMDD-CHALLENGE-slug/
