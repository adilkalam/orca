---
description: "OS 4.2 Pure Orchestrator - Coordinates pipelines, never writes code"
...
### Step 1.5: Memory-First Context (OS 4.2)
...
### Step 7: Route to Domain Orchestrator (OS 4.2)
...
Task({
  ...
  prompt: `
You are the Next.js Grand Architect for OS 4.2.
...
Task({
  ...
  prompt: `
You are the iOS Grand Architect for OS 4.2.
...
Task({
  ...
  prompt: `
You are the Expo Grand Orchestrator for OS 4.2.
...
Task({
  ...
  prompt: `
You are leading the Data pipeline for OS 4.2.
...
Task({
  ...
  prompt: `
You are leading the SEO pipeline for OS 4.2.
...
Task({
  ...
  prompt: `
You are leading the Design pipeline for OS 4.2.
...
OS 4.2 uses TWO memory systems:
