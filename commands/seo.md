---
description: "SEO content pipeline orchestration with OS 4.0 project context and quality gates"
...
# /seo – SEO Content Pipeline Orchestrator (OS 4.0)
...
await Task({
  ...
  prompt: `
You are the seo-research-specialist (OS 4.0).
...
await Task({
  ...
  prompt: `
You are the seo-brief-strategist (OS 4.0).
...
await Task({
  ...
  prompt: `
You are the seo-draft-writer (OS 4.0).
...
await Task({
  ...
  prompt: `
You are the seo-quality-guardian (OS 4.0).
