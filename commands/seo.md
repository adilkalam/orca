---
description: "SEO content pipeline orchestration with OS 3.0 project context and quality gates"
...
# /seo – SEO Content Pipeline Orchestrator (OS 3.0)
...
await Task({
  ...
  prompt: `
You are the seo-research-specialist (OS 3.0).
...
await Task({
  ...
  prompt: `
You are the seo-brief-strategist (OS 3.0).
...
await Task({
  ...
  prompt: `
You are the seo-draft-writer (OS 3.0).
...
await Task({
  ...
  prompt: `
You are the seo-quality-guardian (OS 3.0).
