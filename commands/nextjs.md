---
description: "OS 5.2 orchestrator entrypoint for Next.js frontend tasks"
...
# /nextjs - Next.js Lane Orchestrator (OS 5.2)
...
### 1.1.1 Reflexion Loading & Constraint Injection (OS 5.2)
